        ...
        {success ? (
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2">
              ...
              <input name="name" type="text" className="w-full bg-white/[0.06] border border-white/[0.1] rounded-xl text-white px-4 py-3 focus:outline-none focus:border-white/30 focus:bg-white/[0.08] transition-all placeholder:text-white/20" placeholder="Agent Name" required />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input name="password" type="password" className="w-full bg-white/[0.06] border border-white/[0.1] rounded-xl text-white px-4 py-3 focus:outline-none focus:border-white/30 focus:bg-white/[0.08] transition-all placeholder:text-white/20 tracking-widest" placeholder="••••••••" required minLength={8} />
            </div>
