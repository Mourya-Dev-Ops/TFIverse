      ...
      >
        ...
        {success ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
            ...
            <Link href="/login" className="inline-block px-6 py-3 bg-white/[0.06] backdrop-blur-sm border border-white/[0.1] rounded-xl text-white/70 hover:text-white hover:border-white/30 transition-all text-xs tracking-widest uppercase font-bold">
              Return to Login
            </Link>
          </motion.div>
        ) : (
