...
import {
  FaArrowLeft, FaShareAlt, FaDownload, FaLink, FaSignOutAlt, FaBell,
    ...
    <main className="bg-black min-h-screen text-white font-sans selection:bg-neutral-800 selection:text-white">
      ...
      <nav className="sticky top-0 z-50 w-full bg-black border-b border-neutral-900 px-4 md:px-8 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-bold text-neutral-300">
          ...
          <button className="flex items-center gap-2 hover:text-white transition-colors"><FaDownload /> Export</button>
          ...
          {isLoggedIn && <img src={avatarUrl} alt="Nav Avatar" className="w-8 h-8 rounded-full border border-neutral-800" />}
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-6 relative pb-12">
        ...
        <div className="absolute -top-20 left-6 z-10">
          ...
          {profile.statusMessage && (
             <div className="absolute -top-8 left-12 glass-premium rounded-2xl px-4 py-2 text-sm flex items-center gap-2 shadow-lg whitespace-nowrap">
        ...
        <div className="pt-28 border-b border-neutral-900 pb-8">
          ...
          {(profile.favoriteHeroSlug || profile.favoriteMovieSlug) && (
            <div className="flex flex-wrap gap-3 mb-6">
              {profile.favoriteHeroSlug && (
                <div className="flex items-center gap-2 px-4 py-1.5 glass-premium rounded-full text-sm font-semibold">
          ...
          <div className="flex items-center gap-4 mb-6">
             <div className="flex items-center gap-2 px-4 py-2 glass-premium rounded-xl text-sm font-semibold">
              ...
              {isOwnProfile ? (
                ...
                <button 
                  ...
                  className={`px-6 py-2.5 rounded-lg font-bold text-sm transition-colors ${
                    isFollowing 
                      ? "bg-[#111] border border-neutral-800 text-white hover:bg-neutral-900" 
