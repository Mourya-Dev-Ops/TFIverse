    ...
    <main className="min-h-screen bg-black text-white selection:bg-white/20">
      ...
      <div className="max-w-[1200px] mx-auto px-6 pt-28 pb-20 relative z-10">
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          <div className="p-5 rounded-2xl glass-premium">
            ...
            {filtered.map((list) => {
              ...
              return (
                <div key={list.id} className="group relative">
                  <div className="p-6 rounded-2xl glass-premium hover:border-white/30 transition-all duration-300 h-full flex flex-col">
