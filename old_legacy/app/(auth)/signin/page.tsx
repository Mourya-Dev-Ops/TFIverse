        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white py-3 rounded-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
          ...
          <p className="text-center text-white/60 mt-6 text-sm">
            ...
            <Link href="/signup" className="text-[#E50914] hover:underline font-semibold">
              Sign up
            </Link>
          </p>
        </div>
